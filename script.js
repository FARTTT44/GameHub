...
if (labCtx) {
  ...
  function resetLab() {
    ...
    // Increase difficulty only when player cleared previous room (except first load)
    // Determine farthest cell for fairness but hunters will be set later in placeKeysTrapsHunters
